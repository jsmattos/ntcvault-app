...
* `0.4.13`
  ...
  * Upgraded all dependencies to the latest
  * Refactored TypeScript types to get them linted and verified - issue [#35](https://github.com/jsmattos/hashi-vault-js/issues/35)
  * Fixed `package.json` to accept node engine `v14` - issue [#32](https://github.com/jsmattos/hashi-vault-js/issues/32)
  * Fixed TypeScript types to match main code and allow contructor without certificates - issue [#31](https://github.com/jsmattos/hashi-vault-js/issues/31)
